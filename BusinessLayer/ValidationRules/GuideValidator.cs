...
namespace BusinessLayer.ValidationRules
{
    public class GuideValidator : AbstractValidator<Guide>
    {
        public GuideValidator()
        {
            ...
            RuleFor(x => x.Name).MaximumLength(30).NotEmpty().WithMessage("Lütfen 30 karakterden daha kısa bir isim giriniz");
            RuleFor(x => x.Name).MinimumLength(2).NotEmpty().WithMessage("Lütfen 2 karakterden daha uzun bir isim giriniz");
        }
    }
}
